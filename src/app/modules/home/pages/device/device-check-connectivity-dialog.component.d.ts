...
import { BasicTransportType, DeviceTransportType, NetworkTransportType, PublishTelemetryCommand } from '../../../../../../../thingsboard/ui-ngx/src/app/shared/models/device.models';
...
export declare class DeviceCheckConnectivityDialogComponent extends DialogComponent<DeviceCheckConnectivityDialogComponent> implements OnInit, OnDestroy {
    ...
    deviceTransportTypeTranslationMap: Map<import("../../../../../../../thingsboard/ui-ngx/src/app/shared/models/device.models").TransportType, string>;
