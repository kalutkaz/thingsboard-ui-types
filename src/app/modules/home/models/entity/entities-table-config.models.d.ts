...
import { EntitiesDataSource, EntitiesFetchFunction } from '../../../../../../../thingsboard/ui-ngx/src/app/modules/home/models/datasource/entity-datasource';
...
import { IEntitiesTableComponent } from '../../../../../../../thingsboard/ui-ngx/src/app/modules/home/models/entity/entity-table-component.models';
...
export declare class EntityTableConfig<T extends BaseData<HasId>, P extends PageLink = PageLink, L extends BaseData<HasId> = T> {
    ...
    defaultTimewindowInterval: import("../../../../../../../thingsboard/ui-ngx/src/app/shared/models/time/time.models").Timewindow;
