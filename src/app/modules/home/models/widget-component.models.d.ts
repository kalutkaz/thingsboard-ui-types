...
import { DataSet, Datasource, DatasourceData, FormattedData, JsonSettingsSchema, Widget, WidgetActionDescriptor, WidgetActionSource, WidgetConfig, WidgetControllerDescriptor, WidgetType, widgetType, WidgetTypeDescriptor, WidgetTypeDetails, WidgetTypeParameters } from '../../../../../../thingsboard/ui-ngx/src/app/shared/models/widget.models';
import { Timewindow, WidgetTimewindow } from '../../../../../../thingsboard/ui-ngx/src/app/shared/models/time/time.models';
import { IAliasController, IStateController, IWidgetSubscription, IWidgetUtils, RpcApi, StateParams, SubscriptionEntityInfo, TimewindowFunctions, WidgetActionsApi, WidgetSubscriptionApi } from '../../../../../../thingsboard/ui-ngx/src/app/core/api/widget-api.models';
...
import { WidgetLayout } from '../../../../../../thingsboard/ui-ngx/src/app/shared/models/dashboard.models';
...
import { CustomDialogService } from '../../../../../../thingsboard/ui-ngx/src/app/modules/home/components/widget/dialog/custom-dialog.service';
...
import { AlarmQuery, AlarmSearchStatus, AlarmStatus } from '../../../../../../thingsboard/ui-ngx/src/app/shared/models/alarm.models';
import { MillisecondsToTimeStringPipe, TelemetrySubscriber } from '../../../../../../thingsboard/ui-ngx/src/app/shared/public-api';
