import { DataKey, Datasource, DatasourceData } from '../../../../../../../../thingsboard/ui-ngx/src/app/shared/models/widget.models';
...
export declare const iconStyle: (size: number, sizeUnit: cssUnit) => ComponentStyle;
export declare const textStyle: (font: Font, lineHeight?: string, letterSpacing?: string) => ComponentStyle;
