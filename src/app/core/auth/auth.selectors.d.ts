...
export declare const selectUserDetails: import("@ngrx/store").MemoizedSelector<object, import("../../../../../thingsboard/ui-ngx/src/app/shared/models/user.model").User, (s1: AuthState) => import("../../../../../thingsboard/ui-ngx/src/app/shared/models/user.model").User>;
