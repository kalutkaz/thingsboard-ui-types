...
import { DeprecatedFilter, WidgetType, widgetType, WidgetTypeDetails, WidgetTypeInfo } from '../../../../../thingsboard/ui-ngx/src/app/shared/models/widget.models';
...
export declare class WidgetService {
    ...
    getWidgetBundles(pageLink: PageLink, fullSearch?: boolean, config?: RequestConfig): Observable<PageData<WidgetsBundle>>;
