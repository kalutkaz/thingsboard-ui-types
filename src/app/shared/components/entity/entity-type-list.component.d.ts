...
export declare class EntityTypeListComponent implements ControlValueAccessor, OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EntityTypeListComponent, "tb-entity-type-list", never, { "required": "required"; "customClasses": "customClasses"; "appearance": "appearance"; "label": "label"; "disabled": "disabled"; "subscriptSizing": "subscriptSizing"; "allowedEntityTypes": "allowedEntityTypes"; "placeholder": "placeholder"; "ignoreAuthorityFilter": "ignoreAuthorityFilter"; }, {}, never, ["[additionalButtons]"], false, never>;
}
export {};
